<template>
  <div class="overflow-y-auto overflow-x-hidden flex-grow">
    <ul class="flex flex-col py-2 space-y-1">
      ...
      <li>
        <a class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6" href="/">
      ...
      <li>
        ...
        >
          ...
          <SideBarNotification
            :class="['text-indigo-500', 'bg-indigo-50']"
            :text="'New'"
          ></SideBarNotification>
        </a>
      </li>
      ...
      -->
      <SideBarHead v-if="$auth.loggedIn" :title="'Content'"></SideBarHead>
      ...
      <li v-if="$auth.loggedIn">
        <a class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6" href="#">
          ...
          <span class="ml-2 text-sm tracking-wide truncate" @click="userLogout">Logout</span>
        </a>
      </li>
      <li v-if="!$auth.loggedIn">
        <a
