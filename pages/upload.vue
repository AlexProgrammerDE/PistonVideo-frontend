<template>
  <div class="flex min-h-screen bg-gray-50 text-gray-800">
    <SideBarComponent />
    <form autocomplete="off" class="relative p-5" @submit.prevent="submit">
      ...
      >
        ...
        <span v-if="video" class="mt-2 text-base leading-normal">{{ video.name }} </span>
        <input ref="videoInput" accept=".mp4" class="hidden" required type="file" @change="previewFiles" />
      </label>
      <br />
      <br />
      ...
      >
        ...
        <span class="mt-2 text-base leading-normal">Select a file</span>
        <span v-if="thumbnail" class="mt-2 text-base leading-normal">{{ thumbnail.name }}</span>
        <input ref="thumbnailInput" accept=".png" class="hidden" required type="file" @change="previewFiles" />
      </label>
      <br />
