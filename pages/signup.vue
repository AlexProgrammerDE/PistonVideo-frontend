      ...
      <form @submit.prevent="userLogin">
        <div v-if="invalid" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
          ...
          <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
            <button class="fill-current h-6 w-6 text-red-500" @click="invalid = false">
              <svg class="fill-current h-6 w-6 text-red-500" role="button" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" @click="invalid = false">
                <title>Close</title>
                <path
        ...
        <div class="flex flex-col gap-4 px-0 py-4">
          <div>
            ...
            <input v-model="login.username" class="py-2 pl-10 border border-gray-200 w-full bg-gray-200 text-gray-700 focus:border-gray-100" placeholder="Username" required type="text" />
          </div>
          <div>
            ...
            <input v-model="login.email" class="py-2 pl-10 border border-gray-200 w-full bg-gray-200 text-gray-700 focus:border-gray-100" placeholder="Email address" required type="email" />
          </div>
          <div>
            ...
            <input v-model="login.password" class="py-2 pl-10 border border-gray-200 w-full bg-gray-200 text-gray-700 focus:border-gray-100" placeholder="Password" required type="password" />
          </div>
          <div>
            ...
            <input v-model="login.password_repeat" class="py-2 pl-10 border border-gray-200 w-full bg-gray-200 text-gray-700 focus:border-gray-100" placeholder="Password" required type="password" />
          </div>
          <div class="w-full flex flex-row gap-2">
            <button
              class="p-2 border border-indigo-500 hover:bg-indigo-500 hover:text-white duration-100 ease-in-out w-6/12 text-indigo-500 flex flex-row justify-center items-center gap-1"
              type="submit"
            >
