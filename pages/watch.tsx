      ...
      <SideBarComponent />
      {
        ...
        <div className='m-5 w-full shadow-lg bg-gray-100'>
          ...
          <div className='px-6 py-3'>
            ...
            <div className='text-gray-700 text-lg py-1' dangerouslySetInnerHTML={{ __html: video.description }} />
            ...
            <div className='my-3 flex flex-row w-full bg-gray-300 items-center p-6 space-x-6 rounded-xl shadow-lg'>
              <Image className='rounded-full h-10 w-10 items-center justify-center' src={video.uploader.avatarUrl} />
              <a className='inline-block text-gray-700 text-lg py-1'
                 href={'/user?id=' + video.uploader.id}>{video.uploader.username}</a>
            </div>
          </div>
        </div>
      }
