      ...
      <form @submit.prevent="userLogin">
        ...
        <div class="flex flex-col gap-4 px-0 py-4">
          ...
          <div class="w-full flex flex-col gap-2">
            ...
            >
              <svg aria-hidden="true" class="w-5" preserveAspectRatio="xMidYMid meet" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none">
                  <path
                    clip-rule="evenodd"
            ...
            >
              <svg fill="none" height="24" viewBox="0 0 71 55" width="24" xmlns="http://www.w3.org/2000/svg">
      ...
      try {
        await this.$auth.loginWith('local', {
          data: {
            ...
            password: hash.update(this.login.password).digest('hex'),
          },
        });
